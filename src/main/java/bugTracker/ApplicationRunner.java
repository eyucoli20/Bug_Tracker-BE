...
import bugTracker.userManager.role.RoleRepository;
...
public class ApplicationRunner {
    ...
    private List<Role> createUserRole() {
        Role admin = new Role("ADMIN", "Full access to all features");
        Role developer = new Role("DEVELOPER", "Access to bug tracking and development features");
        Role tester = new Role("TESTER", "Access to bug tracking and testing features");

        return List.of(admin, developer, tester);
    }
